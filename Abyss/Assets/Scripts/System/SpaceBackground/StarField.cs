...
namespace System.SpaceBackground
{
    public class StarField : MonoBehaviour
    {
        ...
        public StarField SetStarsPositionAndScale()
        {
            ...
            {
                var scale = UnityEngine.Random.Range(0.1f, _maxScale);
                starTransform.localPosition = new Vector3(UnityEngine.Random.Range(-_rangeNumber,_rangeNumber), UnityEngine.Random.Range(-_rangeNumber,_rangeNumber), 0);
