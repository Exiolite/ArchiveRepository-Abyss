...
namespace System.SpaceBackground
{
    public class AsteroidField : MonoBehaviour
    {
        ...
        {
            _asteroidFieldHolderTransform.eulerAngles = new Vector3(UnityEngine.Random.Range(0.0f,359.0f),UnityEngine.Random.Range(0.0f,359.0f), UnityEngine.Random.Range(0.0f,359.0f));
            return this;
        }

        public AsteroidField SetActiveWithChance()
        {
            var asteroidsFieldChance = UnityEngine.Random.Range(0.0f, 10);
